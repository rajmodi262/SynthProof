...
leakage. We are deliberate that this is a loose bound: our canary audit is a black-box membership
attack, and Annamalai et al.~\cite{annamalai2024} show that black-box attacks on differentially
private synthetic-data generators read an empirical $\eps\approx0$ even when the true $\eps$ is as high
as $4$ (tight estimates need white-box, worst-case auditing). Reporting the ceiling beside the number
is precisely what keeps a black-box $0.0$ from being read as safety.
