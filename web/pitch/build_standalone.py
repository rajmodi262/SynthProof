...
Run from the repository root:
    ...
    python web/pitch/build_standalone.py

Writes `SynthProof-Pitch.html` beside the SynthProof folder. The normal served build in
...
def inline() -> str:
    ...
    for probe in (".tape-track", ".scoreboard", "@font-face", "data:font/woff2"):
    ...
    banner = (
        ...
        "  Rebuild:  python web/pitch/build_standalone.py\n"
        "-->\n"
    )
    return banner + html
