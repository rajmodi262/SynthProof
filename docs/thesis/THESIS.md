...
7. **Dataset Specificity of Mechanism Advantage**: As shown in Chapter 7 and `results/bank/BANK_MARKETING.md`, the structural superiority of AIM observed on UCI Adult does not transfer to ACSIncome or UCI Bank Marketing, where pairwise marginal modeling matches or outperforms AIM due to workload selection dynamics and domain expansion.
