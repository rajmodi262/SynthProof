...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    /* Distinct from both. "We could not check" is not "we checked and it passed", and it is
       not "we checked and it failed" either. Amber, and it says so in words. */
    .badge-unverifiable {{ background: rgba(245, 158, 11, 0.15); color: #fbbf24; border: 1px solid rgba(245, 158, 11, 0.3); }}
